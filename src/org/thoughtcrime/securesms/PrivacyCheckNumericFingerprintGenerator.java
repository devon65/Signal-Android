...
// this file is copied from NumericFingerprintGenerator.java and slightly modified to
// allow for returning the local and remote device identifiers separately
...
public class PrivacyCheckNumericFingerprintGenerator {
     ...
     *                   - 5200 > 112 bits
     */
    public PrivacyCheckNumericFingerprintGenerator(int iterations) {
        this.iterations = iterations;
    }

    /**
     * Generate a displayble fingerprint.
     *
    ...
    public PrivacyCheckDisplayableFingerprint createFor(String localStableIdentifier, final IdentityKey localIdentityKey,
     ...
     * @return A unique fingerprint for this conversation.
     */
    public PrivacyCheckDisplayableFingerprint createFor(String localStableIdentifier, List<IdentityKey> localIdentityKeys,
                                 String remoteStableIdentifier, List<IdentityKey> remoteIdentityKeys)
    {
        ...
        return new PrivacyCheckDisplayableFingerprint(localFingerprint, remoteFingerprint);
    }
